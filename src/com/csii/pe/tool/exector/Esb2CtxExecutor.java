...
public class Esb2CtxExecutor extends AbstractExecutor {
	private Log log = LogFactory.getLog(this.getClass());

	public Esb2CtxExecutor(String filePath, String fileName, String msgField,
	...
	@Override
	public void execute() {
		log.info("generate esb=>context message file begin.");
		...
		for (int i = 0; i < msgFields.length; i++) {
			...
			strBuffer.append("\t<xmlTag tagName=\"");
